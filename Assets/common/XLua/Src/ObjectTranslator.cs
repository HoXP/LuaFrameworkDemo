...
#pragma warning restore 414
    ...
    public partial class ObjectTranslator
	{
        ...
        //延迟加载
        private readonly Dictionary<Type, OnCallBackRealStatePtr> delayWrap = new Dictionary<Type, OnCallBackRealStatePtr>();
        ...
        public void DelayWrapLoader(Type type, OnCallBackRealStatePtr loader)
        {
        ...
        {
            UnityEngine.Debug.Log("index===" + delegate_bridges.Count);
        ...
        {
            return FindType(className, false);
        }

        internal Type FindType(string className, bool isQualifiedName)
		{
        ...
        {
            return getTypeId(L, type, out is_first, LOGLEVEL.WARN);
        }
        internal int getTypeId(RealStatePtr L, Type type, out bool is_first, LOGLEVEL log_level)
        {
            int type_id;
            is_first = false;
