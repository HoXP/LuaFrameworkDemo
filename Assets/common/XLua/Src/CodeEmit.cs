...
namespace XLua
{
    public class CodeEmit
    {
        ...
        {
            EmitGetObject(il, offset, type, L, translator, offsetBase, false);
        }
        ...
        {
            return defineImplementMethod(type_builder, to_be_impl, attributes, null);
        }
        ...
        MethodBuilder emitMethodWrap(TypeBuilder typeBuilder, List<MethodBase> methodsToCall, bool isIndexer, Type declaringType)
        {
            return emitMethodWrap(typeBuilder, methodsToCall, isIndexer, declaringType, null);
        }
