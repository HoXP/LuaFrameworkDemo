...
namespace XLua
{
    ...
    public class MethodWrapsCache
    {
        ...
        {
            return _GenMethodWrap(type, methodName, methodBases, false);
        }
        public MethodWrap _GenMethodWrap(Type type, string methodName, IEnumerable<MemberInfo> methodBases, bool forceCheck)
        { 
