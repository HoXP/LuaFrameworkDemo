...
namespace XLua
{
    ...
    public static partial class Utils
    {
        ...
        public static List<Type> GetAllTypes(bool exclude_generic_definition)
        {
        ...
        static void makeReflectionWrap(RealStatePtr L, Type type, int cls_field, int cls_getter, int cls_setter,
            int obj_field, int obj_getter, int obj_setter, int obj_meta, out LuaCSFunction item_getter, out LuaCSFunction item_setter)
        {
            makeReflectionWrap(L, type, cls_field, cls_getter, cls_setter, obj_field, obj_getter, obj_setter, obj_meta, out item_getter, out item_setter, false);
        }

        static void makeReflectionWrap(RealStatePtr L, Type type, int cls_field, int cls_getter, int cls_setter,
            int obj_field, int obj_getter, int obj_setter, int obj_meta, out LuaCSFunction item_getter, out LuaCSFunction item_setter, bool private_access)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
