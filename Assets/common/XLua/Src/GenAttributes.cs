...
namespace XLua
{
    ...
    public class LuaCallCSharpAttribute : Attribute
    {
        ...
        public LuaCallCSharpAttribute(GenFlag flag)
        {
            this.flag = flag;
        }
    }
    ...
    public class GCOptimizeAttribute : Attribute
    {
        ...
        public GCOptimizeAttribute()
        {
            this.flag = OptimizeFlag.Default;
        }
        public GCOptimizeAttribute(OptimizeFlag flag)
        {
            this.flag = flag;
        }
    }
    ...
    public class HotfixAttribute : Attribute
    {
        ...
        {
            flag = HotfixFlag.Stateless;
        }
        public HotfixAttribute(HotfixFlag e)
        {
            flag = e;
        }
    }
